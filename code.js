...
function draw() {
    ...
    //add elements
    addArtifact("streakleft1.png", flarecenter[0], flarecenter[1], (docWidth + (flarecenter[0] - docWidth / 2) * 1.5) / 1.5, docHeight / 6);
    addArtifact("streakright1.png", flarecenter[0], flarecenter[1], (docWidth - (flarecenter[0] - docWidth / 2) * 1.5) / 1.5, docHeight / 6);
