...
function draw() {
    ...
    //add elements
    addArtifact("streakleft1.png", flarecenter[0], flarecenter[1], docHeight - (flarecenter[0] - docWidth / 2), docHeight / 7);
    addArtifact("streakright1.png", flarecenter[0], flarecenter[1], docHeight + (flarecenter[0] - docWidth / 2), docHeight / 7);
