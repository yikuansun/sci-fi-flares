...
function draw() {
    ...
    //add elements
    addArtifact("streakleft1.png", flarecenter[0], flarecenter[1], flarecenter[0] - docWidth / 2 + 700, 250);
    addArtifact("streakright1.png", flarecenter[0], flarecenter[1], docWidth / 2 - flarecenter[0] + 700, 250);
