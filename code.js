...
function draw() {
    ...
    //add elements
    addArtifact("streakleft1.png", flarecenter[0], flarecenter[1], docHeight / 2 + (flarecenter[0] - docWidth / 2) / docWidth, docHeight / 7);
    addArtifact("streakright1.png", flarecenter[0], flarecenter[1], docHeight / 2 - (flarecenter[0] - docWidth / 2) / docWidth, docHeight / 7);
